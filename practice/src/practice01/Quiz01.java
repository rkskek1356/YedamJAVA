	...
	public static void main(String[] args) {
		// 문제1) 아래와 같이 각 변수를 초기화하였을 때 각 문제에 맞게 구현하세요.
			 ...
			 // 문제3) 각 연산식을 대입 연산자 하나로 구성된 연산식으로 수정하세요.
				...
				if((a >= 0) && (b >= 0)) {
					System.out.println("5 = both a and b are zero or more");
				} else {
					System.out.println("5 = One of a or b is negative number");
				}
	}
}